                ...
                <div class="menu-container" id="menu-container">
                    <div class="menu">
                        ...
                        <div id="hidden-buttons-container">
                            ...
                            <a href="Orders.html" class="my-custom-block" id="hidden-button-3"><i
                                    class="ion-md-book"></i>Orders</a>
                            <a href="customers.html" class="my-custom-block" id="hidden-button-4"><i
                        ...
                        <a href="contacto.html" class="my-custom-block" id="Contact-button">Contact us</a>
                        <a href="login.html" class="my-custom-block" id="Log-button"><i class="ion-md-open"></i>Log out</a>
                    </div>
                </div>
                        ...
                        <li class="navbar-nav dropdown">
                            <div class="position-relative">
                                ...
                                <div id="hidden-buttons-container5" class="position-absolute"
                                    ...
                                    <a href="login.html" class="my-custom-block" id="hidden-button-5"
        ...
        <section style="flex: 1; display: flex; justify-content: center; align-items: center;">
           <div class="card-header2 bg-light" style="flex: 1; margin-right: 10px; margin-top: 20px;">
            ...
            <a href="productosadd.html" class="my-custom-block" class="product-add"
               ...
               <a href="Productosup.html" class="my-custom-block" class="product-up"
               style="font-family: 'Source Sans 3', sans-serif; margin-top: 10px;background-color: #202123;text-decoration: none; color: #ffffff;">Delete Products</a> 
            </div>
                <table class="table">
                    <thead>
                        <tr>
